...
#              WRITE_YOUR_ANSWER_HERE, The origin is in the top left corner.
#
#        -- In what direction on the screen does the positive X-axis point?
#              WRITE_YOUR_ANSWER_HERE, To the right.
#
#        -- In what direction on the screen does the positive Y-axis point?
#              WRITE_YOUR_ANSWER_HERE, Downward.
#
...
#            WRITE_YOUR_ANSWER_HERE, window = rg.RoseWindow(400, 100)
...
#                WRITE_YOUR_ANSWER_HERE, Arc, Rectangle
#
#          -- Write the names of three METHODs that Circle objects have:
#               (Hint: Use the circle from the example3 function below with the dot trick to let PyCharm help you. )
#                WRITE_YOUR_ANSWER_HERE, clone(self), move_center_to(self, x, y), __reduce__(self)
#
#          -- Write the names of three INSTANCE VARIABLEs that Circle objects have:
#                WRITE_YOUR_ANSWER_HERE, center_point, radius, fill_color
#
#     f. What does a RoseWindow RENDER method do?
#            WRITE_YOUR_ANSWER_HERE, Draw ALL the objects attached to this window.
#
#     g. When is a RoseWindow close_on_mouse_click method call necessary?  Why?
#            WRITE_YOUR_ANSWER_HERE, It is necessary when you want the window to close on the mouse click after
#            the end of a code.
#
